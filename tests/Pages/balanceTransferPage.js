...
class BalanceTransferPage {
    ...
    async openBalanceTransferPage() {
        ...
        // Compare button
        this.compareButton = this.page.locator('input[value="Compare"]');

        // News section
        this.newsSection = this.page.locator('(//a[@class="hl__blog__col__box--anchor"])[1]');

        // Search field
        this.searchField = this.page.locator('input[placeholder="Search..."]').first();
    }
